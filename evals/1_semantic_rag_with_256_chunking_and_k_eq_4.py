...
# Chunk sizing: smaller chunks (256) for fine-grained retrieval; larger chunks for context preservation
CHUNK_SIZE = 256
...
AGENT_RESPONSES_CACHE_FILE = CACHE_DIR / "agent_responses_cache_sm_256_chunking_k_4.json"
RAGAS_RESULTS_CACHE_FILE = CACHE_DIR / "ragas_results_cache_sm_256_chunking_k_4.pkl"
...
def main():
    ...
    # Chunk code into smaller pieces (256 chars each) using recursive splitter
